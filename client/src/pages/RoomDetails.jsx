...
const RoomDetails = () => {
  const { id } = useParams();
  const { navigate, axios, getToken, rooms } = useAppContext();
  ...
  const checkAvailability = async () => {
    try {
      // check is check-in date is grater tha check-out date
  ...
  //  onSubmitHandler function to check availabity & book the room
